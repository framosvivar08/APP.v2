...
public class MainActivity extends AppCompatActivity {
    ...
    public void calcular (View view){
        ...
        double pago = sbase+(horas_mensuales*vtime);
        ...
        if(chbxDcto.isChecked() == true && pagof >sbase){

            lbl_dcto.setText(String.valueOf(dcto));
        }
        if (rgRedondeo.getCheckedRadioButtonId() == R.id.rbRedondeo) {
            int pago_redondeo = (int)Math.round(pagof);
